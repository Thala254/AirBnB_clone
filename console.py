...
class HBNBCommand(cmd.Cmd):
        ...
        if (flag_instance == 1):
            ...
            if (len(cmd3[0]) == 0):
                ...
                if (len(cmd3) == 1):
                    ...
                    dicty = cmd3[1].replace('{', ' ').replace(':', ' ')                         .replace(',', ' ').replace('}', ' ')                         .replace(",  ).replace(', ' ')
                    dicty = dicty.split()
    ...
    def do_create(self, line):
        Creates a new instance of BaseModel, saves it to the JSON file >> console.py
    ...
    def do_show(self, line):
        ...
        if len(cmd_line) == 0:
            ...
            if instance in models.storage.all():
                ...
                print(** no instance found **)' >> console.py
